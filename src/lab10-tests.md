...
Now let's see that cross-domain requests fail:
    ...
    Script test crashed EvalError: Error while calling Python Function (XMLHttpRequest_send): Exception('Cross-origin XHR request not allowed')
        ...
...
JavaScript!
    ...
    Script test crashed EvalError: Error while calling Python Function (XMLHttpRequest_send): Exception('Cross-origin XHR blocked by CSP')
      ...
